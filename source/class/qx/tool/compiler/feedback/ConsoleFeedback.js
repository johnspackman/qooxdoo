qx.Class.define("qx.tool.compiler.feedback.ConsoleFeedback", {
  ...
  members: {
    ...
    __onAddMaker(e) {
      ...
      maker.addListener("writtenApplications", () => qx.tool.compiler.Console.log(`${id}: Written applications...`));
      maker.addListener("writingApplication", evt =>
        qx.tool.compiler.Console.log(`${id}: Writing application ${evt.getData().application.getName()}...`)
      );
