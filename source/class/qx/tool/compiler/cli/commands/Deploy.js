 ...
 * qx.tool.compiler.cli.api.LibraryApi} or {@link qx.tool.compiler.cli.api.CompilerApi}.
 *
 ...
 *
 */
qx.Class.define("qx.tool.compiler.cli.commands.Deploy", {
  ...
  members: {
    ...
    async process() {
      if (!this.argv.clean) {
        qx.tool.compiler.Console.print("qx.tool.compiler.cli.deploy.notClean");
      }
      let compileArgv = {
      ...
      qx.lang.Object.mergeWith(this.argv, compileArgv);
      await super.process();
      let argv = this.argv;
      let appNames = null;
      if (argv.appName) {
  ...
  defer(statics) {
    ...
    qx.tool.compiler.Console.addMessageIds(
      {
        "qx.tool.compiler.cli.deploy.notClean":
