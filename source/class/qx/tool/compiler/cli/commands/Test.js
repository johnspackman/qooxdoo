 ...
 * qx.tool.compiler.cli.api.CompilerApi} or {@link qx.tool.compiler.cli.api.CompilerApi}.
 *
 * - or by implementing a `beforeTests()` method in the class
 * extending {@link qx.tool.compiler.cli.api.CompilerApi}
 *
 * The event and/or method is called with a {@link qx.event.type.Data}
 * containing the command instance.
 *
 */
qx.Class.define("qx.tool.compiler.cli.commands.Test", {
  extend: qx.tool.compiler.cli.commands.Serve,
  ...
  statics: {
    ...
    async createCliCommand(clazz = this) {
      let cmd = await qx.tool.compiler.cli.commands.Serve.createCliCommand(clazz);
      cmd.set({
        name: "test",
  ...
  events: {
     ...
     *  cmd: {qx.tool.compiler.cli.commands.Test}
     */
  ...
  members: {
     ...
     * @param {qx.tool.compiler.cli.api.Test} test
     */
    addTest(test) {
      qx.core.Assert.assertInstance(test, qx.tool.compiler.cli.api.Test);
