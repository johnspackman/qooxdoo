 ...
 */
qx.Class.define("qx.tool.compiler.cli.ConfigDb", {
  ...
  statics: {
     ...
     *
     * @see qx.tool.compiler.cli.ConfigDb.db
     */
    db(path, defaultValue) {
      return qx.tool.compiler.cli.ConfigDb.getInstance().db(path, defaultValue);
    }
  }
});
