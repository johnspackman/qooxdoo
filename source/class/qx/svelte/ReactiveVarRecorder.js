 ...
 */
qx.Class.define("qx.svelte.ReactiveVarRecorder", {
  type: "singleton",
  extend: qx.core.Object,  
  members: {
    /**
     * @type {Array<qx.data.ReactiveVar[]>}
     */
    __stack: [],

    /**
     * Adds a reactive variable to the current recording context.
     * @param {qx.data.ReactiveVar} reactiveVar 
     */
  ...
  statics: {
     ...
     * @returns {Array<qx.data.ReactiveVar>} The array of the owned ReactiveVars. This may grow as new ReactiveVars are created.
     */
    beginRecording() {
     ...
     * @returns {Array<qx.data.ReactiveVar>} The array of the owned ReactiveVars.
     */
    endRecording() {
