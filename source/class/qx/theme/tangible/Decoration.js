...
qx.Theme.define("qx.theme.tangible.Decoration", {
  ...
  decorations: {
    ...
    "button-box-hovered": {
      ...
      style: { backgroundColor: "button-hovered" }
    },
    ...
    */
    ...
    "scroll-knob-pressed": {
      ...
      style: { backgroundColor: "text-primary-on-surface" }
    },

    "scroll-knob-hovered": { include: "scroll-knob" },

    "scroll-knob-pressed-hovered": { include: "scroll-knob-pressed" },
    ...
    "table-header-column-button": { include: "table-header" },
